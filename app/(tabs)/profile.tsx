...
import { Button, Card, SectionTitle, Sub, TextInputLine } from '../../src/components/ui';
...
export default function ProfileScreen() {
  ...
  const clearAll = () => {
    Alert.alert('清空所有数据？', '包括个人信息、训练记录、饮食记录、体重与减脂计划，不可恢复。', [
      ...
      <ScrollView contentContainerStyle={s.body}>
        ...
        <Card style={{ marginTop: 12 }}>
          ...
          <View style={s.nutGrid}>
            ...
            <View style={s.nutItem}><Text style={[s.nutV, { color: C.info }]}>{nut.protein}g</Text><Sub>蛋白质</Sub></View>
...
const s = StyleSheet.create({
  ...
  nutV: { color: C.text, fontSize: 17, fontWeight: '800', marginBottom: 3 },
});
